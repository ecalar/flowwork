  ...
  return (
    <div className="min-h-screen bg-slate-100 flex font-sans text-slate-800">
      ...
      <aside className="w-64 bg-white/70 backdrop-blur-xl border-r border-white/50 shadow-[4px_0_24px_rgba(0,0,0,0.02)] flex flex-col">
        ...
        <div className="p-4 m-4 bg-white/80 rounded-xl border border-white/60 shadow-sm text-sm text-center text-slate-500">
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        <Outlet /> {/* Aquí es donde React Router inyectará las páginas */}
      </main>
    </div>
  );
}